$(document).ready(function() {
    ...
    $('<style>.timeline-container { opacity: 0; transform: translateY(40px); transition: opacity 0.6s ease-out, transform 0.6s ease-out; } .timeline-container.visible { opacity: 1; transform: translateY(0); }</style>').appendTo('head');
    ...
    $('<style>.mv-card, .facility-card { opacity: 0; transform: translateY(50px); transition: opacity 0.5s ease-out, transform 0.5s ease-out; } .mv-card.animate-card, .facility-card.animate-card { opacity: 1; transform: translateY(0); }</style>').appendTo('head');
